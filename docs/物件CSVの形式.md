...
> 2026-08-25 修正：エリアの表が複製元（長野県佐久市）のままだった。
> `src/config/property.ts` の `AREAS`（兵庫県20市町）に合わせた。
...
| 列名 | 内容 | 既定値 |
| :--- | :--- | :--- |
| `cityCd` | 市区町村コード（5桁） | `28201`（姫路市） |
| `prefCd` | 都道府県コード | `28`（兵庫県） |
| `syubetu` | 物件種別 | `2` |
...
| :--- | :--- | :--- | :--- |
| 28201 | 姫路市 | 28227 | 宍粟市 |
| 28203 | 明石市 | 28229 | たつの市 |
| 28208 | 相生市 | 28381 | 稲美町 |
| 28210 | 加古川市 | 28382 | 播磨町 |
| 28212 | 赤穂市 | 28442 | 市川町 |
| 28213 | 西脇市 | 28443 | 福崎町 |
| 28215 | 三木市 | 28446 | 神河町 |
| 28216 | 高砂市 | 28464 | 太子町 |
